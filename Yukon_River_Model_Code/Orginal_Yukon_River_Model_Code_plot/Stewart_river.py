...
for i in range(rv.num_samples):
     ...
     velo = [rv.Ste_V100_samples[i],rv.Ste_V1_samples[i]]
     #print(Ste_velo)
     
     bounds =[]
     for j in range(len(rv.Ste_nodes)-1):
         #print(j)
         a = rv.Ste_nodes[j]/(velo[j]*rv.dt*(1/1000))
         b= rv.Ste_nodes[j+1]/(velo[j]*rv.dt*(1/1000))
         bounds.append(a)
         bounds.append(b)
     #print(Ste_bounds) 
     #print(len(Ste_bounds))
    ...
    #values for the while loop
     ...
     #imax values = the last item of the i_sum
     imax.append(i_sum[len(i_sum)-1])
     #print(imax)
     
                                                #   time_calculation    #
     #print("_imax_values:",_imax[i])
...
#print(df)
df.to_csv('output/stewart/Stewart_River_Mouth_Values.csv')
df.to_csv('output/analysis/Stewart_River_Mouth_Values.csv')
