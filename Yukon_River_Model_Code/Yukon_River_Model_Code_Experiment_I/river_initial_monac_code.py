...
hpc_f_std = 83.66/100*(1/10)        # this is the one that actually changing by 10% of the mean
#Polysaccharides-4
...
for i in range(num_parameters):
    ...
    plt.title(Trib_Name[i]+' - Histogram of Traingular Distribution - Velocity') #
    plt.axvline(bounds[i][0], color='k', linestyle='-.', label=f'lower = {bounds[i][0]:.3f}') #
    plt.axvline(bounds[i][2], color='r', linestyle='--', label=f'$\mu = $ {bounds[i][2]}') #
    plt.axvline(bounds[i][1], color='k', linestyle='--', label=f'upper = {bounds[i][1]:.3f}') #
    plt.legend(loc='lower center', bbox_to_anchor = (0.5, -0.3),ncol =3) #
    plt.tight_layout()
    plt.show()
    figure.savefig(f"output/analysis/Figures/1_Velocity_Histogram of Traingular Distribution_{Trib_Name[i]}.png")
...
for i in range(num_parameters):
    ...
    plt.xlabel('Value')
    plt.ylabel('Probability')
    plt.title(Trib_Name[i+1]+' - Histogram of Traingular Distribution - Dilution factor') #
    plt.axvline(bounds[i][0], color='k', linestyle='-.', label=f'lower = {bounds[i][0]:.3f}') #
    plt.axvline(bounds[i][2], color='r', linestyle='--', label=f'$\mu = $ {bounds[i][2]}') #
    plt.axvline(bounds[i][1], color='k', linestyle='--', label=f'upper = {bounds[i][1]:.3f}') #
    plt.legend(loc='lower center', bbox_to_anchor = (0.5, -0.3),ncol =3) #
    # Adjust layout to ensure everything fits, including the legend
    plt.tight_layout()
    plt.show()
    figure.savefig(f"output/analysis/Figures/2_Dilution_factor_Histogram of Traingular Distribution_{Trib_Name[i+1]}.png")
...
for i in range(num_parameters):
    ...
    plt.xlabel('Value')
    plt.ylabel('Probability')
    plt.title(Trib_Name[i]+' - Histogram of Traingular Distribution - DOC') #
    plt.axvline(bounds[i][0], color='k', linestyle='-.', label=f'lower = {bounds[i][0]:.3f}') #
    plt.axvline(bounds[i][2], color='r', linestyle='--', label=f'$\mu = $ {bounds[i][2]}') #
    plt.axvline(bounds[i][1], color='k', linestyle='--', label=f'upper = {bounds[i][1]:.3f}') #
    plt.legend(loc='lower center', bbox_to_anchor = (0.5, -0.3),ncol =3) #
    plt.tight_layout()
    plt.show()
    figure.savefig(f"output/analysis/Figures/3_DOC_Histogram of Traingular Distribution_{Trib_Name[i]}.png")
...
for i in range(num_parameters):
    ...
    plt.xlabel('Value')
    plt.ylabel('Probability')
    plt.title('f_hpc - Histogram of Traingular Distribution - Chemical fraction') #
    plt.axvline(bounds[i][0], color='k', linestyle='-.', label=f'lower = {bounds[i][0]:.3f}') #
    plt.axvline(bounds[i][2], color='r', linestyle='--', label=f'$\mu = $ {bounds[i][2]}') #
    plt.axvline(bounds[i][1], color='k', linestyle='--', label=f'upper = {bounds[i][1]:.3f}') #
    plt.legend(loc='lower center', bbox_to_anchor = (0.5, -0.3),ncol =3) #
    plt.tight_layout()
    plt.show()
    #figure.savefig(f"output/analysis/Figures/4_Chemical_fraction_Histogram of Traingular Distribution_f_hpc.png")
    figure.savefig(f"output/analysis/Figures/4_Chemical_fraction_Histogram of Traingular Distribution_f_hpc.png")
#Chemical fraction
...
for i in range(len(Chem_sam)):
    ...
    plt.xlabel('Value')
    plt.ylabel('Probability')
    plt.title(Chem_frac[i]+' - Histogram of Traingular Distribution - Chemical fraction')
    plt.axvline(bounds_1[i][0], color='k', linestyle='-.', label=f'lower = {bounds_1[i][0]:.3f}') #
    plt.axvline(bounds_1[i][2], color='r', linestyle='--', label=f'$\mu = $ {bounds_1[i][2]}') #
    plt.axvline(bounds_1[i][1], color='k', linestyle='--', label=f'upper = {bounds_1[i][1]:.3f}') #
    plt.legend(loc='lower center', bbox_to_anchor = (0.5, -0.3),ncol =3) #
    plt.tight_layout()
    plt.show()
    figure.savefig(f"output/analysis/Figures/4_Chemical_fraction_Histogram of Traingular Distribution_{Chem_frac[i]}.png")
...
for i in range(len(chem_tau)):
    ...
    plt.xlabel('Value')
    plt.ylabel('Probability')
    plt.title(chem_tau[i]+'Histogram of Traingular Distribution - Tau')
    plt.axvline(bounds[i][0], color='k', linestyle='-.', label=f'lower = {bounds[i][0]:.3f}') #
    plt.axvline(bounds[i][2], color='r', linestyle='--', label=f'$\mu = $ {bounds[i][2]}') #
    plt.axvline(bounds[i][1], color='k', linestyle='--', label=f'upper = {bounds[i][1]:.3f}') #
    plt.legend(loc='lower center', bbox_to_anchor = (0.5, -0.3),ncol =3) #
    plt.tight_layout()
    plt.show()
    figure.savefig(f"output/analysis/Figures/5_Tau_Histogram of Traingular Distribution_{chem_tau[i]}.png")
