...
for i in range(rv.num_samples):
     ...
     velo = [rv.Pel_V100_samples[i],rv.Pel_V1_samples[i]]
     #print(Pel_velo)
     
     bounds =[]
     for j in range(len(rv.Pel_nodes)-1):
         #print(j)
         a = rv.Pel_nodes[j]/(velo[j]*rv.dt*(1/1000))
         b= rv.Pel_nodes[j+1]/(velo[j]*rv.dt*(1/1000))
         bounds.append(a)
         bounds.append(b)
     #print(Pel_bounds) 
     #print(len(Pel_bounds))
    ...
    #values for the while loop
     ...
     #Pelly_imax values = the last item of the Pel_i_sum
     imax.append(i_sum[len(i_sum)-1])
     #print(imax)
     
                                                #   time_calculation    #
     #print("Pel_imax_values:",Pel_imax[i])
...
#print(df)
df.to_csv('output/pelly/Pelly_River_Mouth_Values.csv')
df.to_csv('output/analysis/Pelly_River_Mouth_Values.csv')
