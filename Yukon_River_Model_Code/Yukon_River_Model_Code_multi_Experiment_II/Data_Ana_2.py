...
fig.suptitle('Output DOC Vs Tributary Velocity',fontsize = 25,fontweight= "bold")
...
# Show the plots
plt.show()
fig.savefig(f"output/analysis/Figures/ A_Output DOC Vs Tributary Velocity.png")

# Create a figure and subplots
fig, axs = plt.subplots(3, 3, figsize=(15, 15))
fig.suptitle('DOC Vs Yukon Stem Velocity',fontsize = 25,fontweight= "bold")
fig.subplots_adjust(top=0.95)
...
# Show the plots
plt.show()
fig.savefig(f"output/analysis/Figures/ B_Output DOC Vs Yukon Stem Velocity.png")
...
# Create a figure and subplots
fig, axs = plt.subplots(3, 3, figsize=(15, 15))
fig.suptitle('DOC Vs Dilution Fractions',fontsize = 25,fontweight= "bold")
fig.subplots_adjust(top=0.95)
...
# Show the plots
plt.show()
fig.savefig(f"output/analysis/Figures/ C_Output DOC Vs Dilution Fractions.png")
...
# Create a figure and subplots
fig, axs = plt.subplots(3, 3, figsize=(15, 15))
fig.suptitle('Output DOC Vs Input DOC',fontsize = 25,fontweight= "bold")
fig.subplots_adjust(top=0.95)
...
# Show the plots
plt.show()
fig.savefig(f"output/analysis/Figures/ D_Output DOC Vs Input DOC.png")
...
fig.suptitle('Output DOC Vs Tau',fontsize = 25,fontweight= "bold")
fig.subplots_adjust(top=0.95)
...
# Show the plots
plt.show()
fig.savefig(f"output/analysis/Figures/ E_Output DOC Vs Tau.png")
...
fig.suptitle('Output DOC Vs Chemical fraction',fontsize = 25,fontweight= "bold")
fig.subplots_adjust(top=0.95)
...
# Show the plots
plt.show()
fig.savefig(f"output/analysis/Figures/ F_Output DOC Vs Chemical fraction.png")
