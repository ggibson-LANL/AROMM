...
for i in range(rv.num_samples):
     ...
     velo = [rv.Tan_V100_samples[i],rv.Tan_V1_samples[i]]
     #print(Tan_velo)
     
     bounds =[]
     for j in range(len(rv.Tan_nodes)-1):
         #print(j)
         a = rv.Tan_nodes[j]/(velo[j]*rv.dt*(1/1000))
         b= rv.Tan_nodes[j+1]/(velo[j]*rv.dt*(1/1000))
         bounds.append(a)
         bounds.append(b)
     #print(Tan_bounds) 
     #print(len(Tan_bounds))
    ...
    #values for the while loop
     ...
     #Tanana_imax values = the last item of the Tan_i_sum
     imax.append(i_sum[len(i_sum)-1])
     #print(imax)
     
                                                #   time_calculation    #
     #print("Tan_imax_values:",Tan_imax[i])
...
#print(df)
df.to_csv('output/tanana/Tanana_River_Mouth_Values.csv')
df.to_csv('output/analysis/Tanana_River_Mouth_Values.csv')
