...
fig.suptitle("Humic_and_Sediments_E**1")
...
ax3.axis([2899,3000,-250,20])
ax3.plot(dist3,Conc_Che15[379:479],'grey',label='Sediment')
...
#plt.plot(dist,Conc_Che12,'k:',label='Chem12')
#Protein,Carbohydrates,Heteroplo(Humic,CDOM),Pigments
plt.axis([0,3000,-225,25])
plt.grid(True)
plt.ylabel("Log[C]/micromolar")
plt.xlabel("Distance/km")
plt.title("Plot of Humic and Sediments_E**1")
plt.legend()
plt.show()
