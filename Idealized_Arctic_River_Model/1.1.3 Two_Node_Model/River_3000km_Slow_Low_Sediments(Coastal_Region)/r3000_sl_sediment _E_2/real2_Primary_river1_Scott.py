...
print(rv.C_Conc[i,1],i,"conc1")
print(rv.C_Conc[i,5],i,"conc5")
...
Conc_Che30 = np.log10(TDOC)
Conc_Che30 = Conc_Che30.tolist()
print(Conc_Che30[i],i,"kk")
print(rv.C_Conc[i,1],i,"conc1nod1mixing")
print(rv.C_Conc[i,5],i,"conc5nod1mixing")
print(rv.C_Conc[i,:],i)
...
while i < 290:
   ...
   i=i+1
print(i,"##")
print(Conc_Che30[i],i,"*")
print(rv.C_Conc[i,0])
print(rv.C_Conc[i,1],i,"conc1befnod2mixing")
print(rv.C_Conc[i,5],i,"conc5befnod2mixing")

#the node2 1:1 mixing   
rv.C_Conc[i,:] =((1/2)*rv.C_Conc[i,:])+((1/2)*nd2rv.rv.C_Conc[i,:])
print(rv.C_Conc[i,0])
print(Conc_Che30[i],i,"**")
print(rv.C_Conc[i,1],i,"conc1aftnod2mixing")
print(rv.C_Conc[i,5],i,"conc5aftnod2mixing")
print(rv.C_Conc[i,1],i,"conc1aftnod2mixing")
print(rv.C_Conc[i,5],i,"conc5aftnod2mixing")
...
print(rv.C_Conc[380,1],"380conc1befnod2mixing")
print(rv.C_Conc[380,5],"380conc5befnod2mixing")
print(rv.C_Conc[479,1],"479conc1befnod2mixing")
print(rv.C_Conc[479,5],"479conc5befnod2mixing")
...
#print("The velocity is" , velo , "m/s")
#list of no of steps, in distance(km)
dist2 = np.arange(10,290)*dt*velo*(1/1000)
dist2 = dist2.tolist()
#print("* Distance")
#print(dist2)
...
#print("The velocity is" , velo , "m/s")
#list of no of steps, in distance(km)
dist3 = np.arange(2900,3000)*dt*velo*(1/1000)
dist3 = dist3.tolist()
#print("* Distance")
#print(dist3)
#print(dist2)
...
print("380",rv.C_Conc[380:479,6])
print("380",rv.C_Conc[380:479,15])
plt.plot(dist3,rv.C_Conc[379:479,6],'k-',label='Humic')
plt.plot(dist3,rv.C_Conc[379:479,15],'grey',label='Sediment')
...
plt.axis([2899,3000,-1,200])
plt.grid(True)
plt.ylabel("Log[C]/micromolar")
plt.xlabel("Distance/km")
plt.title("The plot of Humic and Sediements")
plt.legend(loc=2)
plt.show()
...
fig.suptitle("Humic_and_Sediments_E**2")
ax  = fig.add_subplot(2,2,1)
ax1 = fig.add_subplot(2,2,2)
ax2 = fig.add_subplot(2,2,3)
ax3 = fig.add_subplot(2,2,4)
#ax.set_facecolor('xkcd:salmon')
ax.axis([2899,3000,-2,200])

ax.plot(dist3,rv.C_Conc[379:479,6],'r-',label='Humic')
#ax.plot(dist3,rv.C_Conc[379:479,15],'grey',label='Sediment')
ax.set_title('Humic')
...
ax1.axis([2899,3000,-10,5])
ax1.plot(dist3,Conc_Che6[379:479],'r--',label='Humic')
#ax1.plot(dist3,rv.C_Conc[379:479,15],'grey',label='Sediment')
ax1.set_title('log[Humic]')
ax1.set_ylabel("log[C]/micromolar")
#ax1.set_xlabel("Distance/km")
ax1.grid(True)
ax1.legend(fontsize='x-small')

ax2.axis([2899,3000,-1,5])
#ax2.plot(dist3,rv.C_Conc[379:479,6],'k-',label='Humic')
ax2.plot(dist3,rv.C_Conc[379:479,15],'grey',label='Sediment')
ax2.set_title('Sediment')
ax2.set_ylabel("[C]/micromolar")
ax2.set_xlabel("Distance/km")
ax2.grid(True)
ax2.legend(fontsize='x-small')

ax3.axis([2899,3000,-15,4])
ax3.plot(dist3,Conc_Che15[379:479],'grey',linestyle='dashed',label='Sediment')
ax3.set_title('log[Sediment]')
...
f= open("E2.txt","w+")
f.write("Humic\n")
f.write(str(Conc_Che6))
f.write("\nSites\n")
f.write(str(Conc_Che15))
f.write("\nDistance\n")
f.write(str(dist))
f.close() 

print("380",Conc_Che6[380:479])
plt.plot(dist,Conc_Che6,'grey',label='Humic')
plt.plot(dist,Conc_Che15,'r-',label='Sediment_site')
#plt.plot(dist,Conc_Che1,'r--',label='Chem1')
#plt.plot(dist,Conc_Che2,'b-.',label='Chem2')
#plt.plot(dist,Conc_Che3,'g-',label='Chem3')
#plt.plot(dist,Conc_Che4,'c--',label='Chem4')
...
#plt.plot(dist,Conc_Che12,'k:',label='Chem12')
#Protein,Carbohydrates,Heteroplo(Humic,CDOM),Pigments
plt.axis([0,3000,-20,3])
plt.grid(True)
plt.ylabel("Log[C]/micromolar")
plt.xlabel("Distance/km")
plt.title("Plot of Humic and Sediments_E**2")
plt.legend()
plt.show()
...
ax3 = fig.add_subplot(2,2,4)
#ax.set_facecolor('xkcd:salmon')
ax.axis([0,3000,0.5,1.5])
#ax.plot(dist,Conc_Che3,color='grey',label='(HPC)')
#ax.plot(dist,Conc_Che,'r-',label='Protein')
ax.plot(dist,Conc_Che,'r-',label='Protein')
ax.plot(dist,Conc_Che4,'k-',label='Carbohydrates')
#ax.plot(dist,Conc_Che2,'k--',label='Amino acids')
ax.set_title('Carbohydrates and Protein')
ax.set_ylabel("Log[C]/micromolar")
#ax.set_xlabel("Distance/km")
ax.grid(True)
ax.legend(fontsize='x-small')
...
ax1.axis([0,3000,-2,1])
#ax1.plot(dist,Conc_Che3,color='grey',label='(HPC)')
ax1.plot(dist,Conc_Che1,'r-',label='Polypeptide')
ax1.plot(dist,Conc_Che5,'k-',label='Oligosaccharides')
#ax1.plot(dist,Conc_Che5,'k-',label='Oligosaccharides')
#ax1.plot(dist,Conc_Che7,'k--',label='Monosaccharides')
ax1.set_title('Polypeptide and Oligosaccharide')
#ax1.set_ylabel("Log[C]/micromolar")
#ax1.set_xlabel("Distance/km")
ax1.grid(True)
ax1.legend(fontsize='x-small')
...
ax2.axis([0,3000,-4,0])
ax2.plot(dist,Conc_Che2,'r--',label='Amino acids')
ax2.plot(dist,Conc_Che7,'k--',label='Monosaccharides')
#ax2.plot(dist,Conc_Che3,color='grey',label='(HPC)')
#ax2.plot(dist,Conc_Che9,'r-',label='Lipid')
#ax2.plot(dist,Conc_Che13,'k-',label='VPhenols')
#ax2.plot(dist,Conc_Che14,'k--',label='SPhenols')
ax2.set_title('Amino aicds and monosaccharides')
ax2.set_ylabel("Log[C]/micromolar")
ax2.set_xlabel("Distance/km")
ax2.grid(True)
ax2.legend(fontsize='x-small')
