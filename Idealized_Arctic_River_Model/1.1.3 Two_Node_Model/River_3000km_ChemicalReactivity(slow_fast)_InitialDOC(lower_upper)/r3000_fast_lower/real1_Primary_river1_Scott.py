#fast_lower
import real1_Primary_river as rv
import real1_node1_river as nd1rv
import real1_node2_river as nd2rv
import math
import numpy as np
...
#ax2.plot(dist,Conc_Che9,'r-',label='Lipids')
